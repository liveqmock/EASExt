			...
			if (_this.YQ.requestType && $.inArray(_this.YQ.requestType, ['iframe', 'ajax','img'])!=-1) {
				...
				if (_this.YQ.requestType === "img") {
					...
					if (_this.YQ.requestType === "ajax") {
						...
						ifr = $("<iframe id='wBoxIframe' name='wBoxIframe' style='width:" + _this.YQ.iframeWH.width + "px;height:" + _this.YQ.iframeWH.height + "px;' scrolling='auto' frameborder='0' src='" + _this.YQ.target + "'></iframe>");
