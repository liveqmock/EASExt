...
var _1f3="<div class=\"messager-msg\">"+msg+"</div>";
switch(icon){
case "error":
...
/**
 * 关于与WdatePicker日期控件整合校验冲突的问题
 * caoyong
 */
$.fn.validatebox.parseOptions_1 = function(_332_1) {
	var t = $(_332_1);
	return $.extend( {}, $.fn.validatebox.parseOptions(_332_1, [ "validType",
...
/***********************selft defined******************************/
	...
	if(opts.onRowMouseoverMenu){
		opts.onRowMouseoverMenu.call(_40c,e,_411,data.rows[_411]);
	}
}).bind("mouseout.datagrid",function(e){
	var _411=$(this).attr("datagrid-row-index");
	if(opts.onRowMouseoutMenu){
		opts.onRowMouseoutMenu.call(_40c,e,_411,data.rows[_411]);
	}
});
