...
<html>
	...
	<div id="dlg" class="easyui-dialog" 
        buttons="#dlg-buttons">  
			<form action="<%=basePath %>admin/functionaction!insertFunction" onsubmit="return check();" method="post">
				...
				<table align="center">
					...
					<tr>
						...
						<td>
							<input type="text" id="funname" name="functionaction.funname" onkeyup="ifFunctionHasExists(this.value);"/>
					...
					<tr>
						...
						<td>
							<input type="text" name="functionaction.url" id="url"/>
							<font style="color:red;font-size:20px">*</font> 
						</td>
					</tr>
					<tr>
