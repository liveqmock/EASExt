	 ...
	 <table id="dg" title="已办信息"  class="easyui-datagrid" style="height:400px;" width="100%"
		...
		<thead>
	  		 ...
	  		 <tr>
	  		    ...
	  		    <td width="50"><font color="red">审批通过</font></td>
	  		...
	  		<tr>
	  		    ...
	  		    <td width="50">张三</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">已反馈</font></td>
<!--	  		    <td width="50"><a href="compliance/backlog/feedback.jsp">查看</a></td>-->
 				<td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		<tr>
	  			<td width="50">电话</td>
	  		    ...
	  		    <td width="50">张三</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">退回</font></td>
	  		    <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
