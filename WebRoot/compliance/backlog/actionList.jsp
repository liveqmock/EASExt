...
<html>
  ...
  <body>
	 <table id="dg" title="已办信息"  class="easyui-datagrid" style="height:400px;" width="100%"
		...
		<thead>
		  		<tr>
		  			...
		  			<th field="sQReason" width="150">提出申请理由</th>
		  	...
		  	<tr>
	  		    ...
	  		    <td width="50">张三</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">转部门已反馈</font></td>
	  		    <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		</c:if>
		    ...
		    <tr>
	  		    ...
	  		    <td width="50">张三</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">转部门已审批 </font></td>
	  		        <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		 <tr>
	  			<td width="50">投诉邮箱</td>
	  		    ...
	  		    <td width="50">张五</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">实地调查已审批</font></td>
	  		       <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		 <tr>
	  			<td width="50">合规邮箱</td>
	  		    ...
	  		    <td width="50">张五</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">结案已初审通过</font></td>
	  		        <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		 <tr>
	  			<td width="50">合规邮箱</td>
	  		    ...
	  		    <td width="50">张五</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">结案未初审通过</font></td>
	  		        <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		</c:if>
	  		...
	  		<tr>
	  		    ...
	  		    <td width="50">张五</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">结案未终审通过</font></td>
	  		       <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		 <tr>
	  			<td width="50">投诉邮箱</td>
	  		    ...
	  		    <td width="50">张五</td>
	  		    <td width="150">其他协助查询/本部门实地调查/申请结案/被投诉人调查处理</td>
	  		    <td width="50"><font color="red">结案已终审通过</font></td>
	  		       <td><a href="javascript:void(0);" onclick="openWinNew('compliance/addCase.jsp');">查看</a></td>
	  		</tr>
	  		</c:if>
		 </table>
