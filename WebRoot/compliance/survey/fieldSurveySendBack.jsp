  ...
  <body>
    <div id="dlg" class="" style="width:x;height:x;padding:x x" closed="true" buttons="#dlg-buttons">
	    ...
	    <div align="center">  
	    	<div class="fitem">            
	    		<label>实际调查时间:</label>
	    		<input type="text" name="complainDate" id="complainDate" value="2013-9-23"/>
	    	</div>
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>被调查人（包括个人和机构）:</label>            
	    		<input type="text" name="complainDate" id="complainDate" value="杨高权"/>
	    	</div> 
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>被调查内容 :</label>            
	    		<input type="text" name="complainDate" id="complainDate" value="zzz"/>
	    	</div> 
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>调查结果 :</label>            
	    		<input type="text" name="complainDate" id="complainDate" value="正常"/>
	    	</div> 
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>协助落实部门时间 :</label>            
	    		<input type="text" name="complainDate" id="complainDate" value="2013-9-23"/>
	    	</div> 
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>要求 :</label>            
	    		<input type="text" name="complainDate" id="complainDate" value="坦白从宽"/>
	    	</div>
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>协助落实部门 :</label>            
	    		<input type="text" name="complainDate" id="complainDate" value="技术部"/>
	    	</div> 
	    		<div class="fitem" id="cusSourceDiv">            
	    		<label>协助落实部门负责人 :</label>            
	    		<input type="text" name="complainDate" id="complainDate" value="柯"/>
	    	</div> 
	    	<div class="fitem" id="cusSourceDiv">            
	    	...
	    	<div class="fitem" id="cusSourceDiv">            
	    		...
	    		<input type="text" name="complainDate" id="complainDate" value="没什么问题"/>
	    	</div>
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>下一步方案 :</label>            
	    		<select name="nextScheme" id="nextScheme" onchange="fun_nextScheme();">
	    			<option>----请选择----</option>
	    		    <option value='1' selected="selected">申请结案</option>
