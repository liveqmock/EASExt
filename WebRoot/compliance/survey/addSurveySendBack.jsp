...
<!--	    		<a href="javascript:void(0);" onclick="openWinNew('compliance/casList.jsp');">选择</a>-->
	    	...
	    	<div class="fitem">            
	    		<label>沟通时间:</label>
	    		<input type="text" name="complainDate" id="complainDate" value="2013-9-23" readonly="readonly"/>
	    	</div>
	    	<div class="fitem">            
	    		<label>沟通对象:</label>
	    		<input type="text" name="complainDate" id="complainDate" value="王五" readonly="readonly"/>
	    	</div>
	    	<div class="fitem">            
	    		<label>沟通对象与投诉人的关系:</label>
	    		<input type="text" name="complainDate" id="complainDate" value="亲戚" readonly="readonly"/>
	    	</div>
	    	<div class="fitem" id="cusSourceDiv">            
	    		<label>沟通内容 :</label>            
	    			<textarea rows="5" cols="20">abcd扽的</textarea>		
	    	</div> 
	    	<div class="fitem" id="serviceTypeDiv">            
    			...
    			<select name="cusStatus" id="cusStatus" onchange="fun_cusStatus();">
	    		    ...
	    		    <option value='2' selected>网络查询</option>
	    	...
	    	<div class="fitem" id="cusStatusDiv">            
	    		...
	    		<select name="nextScheme" id="nextScheme" onchange="fun_nextScheme();">
	    		    ...
	    		    <option value='2' selected>被投诉部门调查处理</option>
	    		    <option value='3'>本部门实地调查</option>
  				  	<option value='4'>申请结案</option>
	    		</select>  
	    	</div>
	    	<div style="display:block;" id="turnDepartmentDiv">
		 		<div class="fitem">            
		    		<label>案件负责人:</label>
		    		<input type="text" name="complainDate" id="complainDate" value="杨丽英"/>
		    	</div>
		    	<div class="fitem">            
		    		<label>转出理由:</label>
		    		<textarea rows="6" cols="20">需要其他部门协助</textarea>
		    	</div>
		    </div>
