  ...
  <body>
    <div id="dlg" class="" style="width:x;height:x;padding:x x" closed="true" buttons="#dlg-buttons">
	    ...
	    <div align="center">  
	    	...
	    	<div class="fitem">            
	    		<label>沟通时间:</label>
	    		<input type="text" name="complainDate" id="complainDate" value="加载服务器时间" readonly="readonly"/>
	    	</div>
	    	<div class="fitem">            
	    		<label>沟通对象:</label>
	    		<input type="text" name="complainDate" id="complainDate" value="" readonly="readonly"/>
	    	</div>
	    	<div class="fitem">            
	    	...
	    	<div class="fitem" id="cusStatusDiv">            
	    		...
	    		<select name="nextScheme" id="nextScheme" onchange="fun_nextScheme();">
	    		    ...
	    		    <option value='2'>被投诉部门调查处理</option>
