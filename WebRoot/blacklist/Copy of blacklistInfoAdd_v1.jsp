		...
		<form action="person/black!save" method="post" >
			<div class="rowelem_50">
			  ...
			  <div class="rowelem">
					...
					<input type="checkbox" name="blackListInfo.warntype" id="processmode" value="<s:property value="id" />"/> 
			 ...
			 <div class="rowelem">
					...
					<input type="checkbox" name="blackListInfo.processmode" id="processmode" value="<s:property value="fid" />"/> 
