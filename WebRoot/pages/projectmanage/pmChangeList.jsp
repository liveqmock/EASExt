	...
	<script type="text/javascript">
   		$(function() {
			...
			$('#tt').datagrid({
				...
				url:'<%=basePath%>pmInfo/pmInfoAction!selectAllPmChange',
				...
				columns: [[
					 {field:'LOANNUMBER',title:'贷款编号',width:fixColumnWidth(0.1200),align:'center'},
					  {field:'BEFOREPM',title:'原PM',width:fixColumnWidth(0.1700),align:'center'},
					  {field:'AFTERPM',title:'变更后PM',width:fixColumnWidth(0.1700),align:'center'},
					  {field:'FCREATEUSERNAME',title:'变更人',width:fixColumnWidth(0.1700),align:'center'},
					  {field:'FCREATETIME',title:'变更时间',width:fixColumnWidth(0.1700),align:'center'}
...
<body>
  <div class="search">
	<table id="queryTab" onKeyUp="bindQuery();">
		<tr>
			...
			<td class="s-t">变更人：</td>
            <td><input class="s-text" type="text" id="userName" ></td>
			<td>
 ...
 <div class="search-list">
  	<span class="list-title">PM修改记录</span>
