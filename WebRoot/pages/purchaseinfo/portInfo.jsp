	...
	<script type="text/javascript">
   		$(function() {
			...
			$('#tt').datagrid({
				...
				url:'<%=basePath%>purchase/purchaseInfo!queryPageJson',
				...
				columns: [[
					 {field:'orgname',title:'使用部门',width:fixColumnWidth(0.1600)},
					  ...
					  {field:'operation',title:'操作',width:fixColumnWidth(0.1400),sortable:true,
...
<div class="search">
	...
	<form action="<%=basePath %>purchase/purchaseInfo!importExcel"  method="post" name="myform" 
 ...
 <div class="search-list">
	...
	<input type="hidden" id="detailURL" value="<%=request.getContextPath()%>/port/portInfo!view?portInfo.id="/>
	<input type="hidden" id="editURL" value="<%=request.getContextPath()%>/port/portInfo!edit?portInfo.id="/>
	<input type="hidden" id="deleteURL" value="<%=request.getContextPath()%>/port/portInfo!delete?portInfo.id="/>
<!--弹出框-->
