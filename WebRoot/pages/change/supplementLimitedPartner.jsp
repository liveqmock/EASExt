...
<head>
	...
	<tr>
	 ...
	 <option value="" selected="selected">请选择普通合伙人（GP）</option>
	 <option value="宜信卓越财富投资管理（北京）有限公司">宜信卓越财富投资管理（北京）有限公司</option>
	 <option value="宜信惠民投资管理（北京）有限公司">宜信惠民投资管理（北京）有限公司</option>
	 <option value="深圳普泽众富资产管理有限公司">深圳普泽众富资产管理有限公司</option>
	 </select><span class="required">*</span></td>
	 <td class="t-title">原有限合伙人（LP）：</td>
	<td><input class="t-text" id="lp"  style="width: 280px;" type="text" name="limitedpartner.formerlimitedpartner" value=""/><span class="required">*</span></td>
	</tr>
	<tr>
	<td class="t-title">代理人：</td>
    <td><input class="t-text" id="proxy" style="width: 280px;" type="text" name="limitedpartner.proxy" value=""/><span class="required">*</span></td>
    <td class="t-title">主要经营场所：</td>
    <td><input class="t-text" id="place" style="width: 280px;" type="text" name="limitedpartner.businessplace" id="cardcode" value=""/><span class="required">*</span></td>
	</tr>
	<tr>
    <td class="t-title">出资时间：</td>
    <td><input class="t-text Wdate" id="time" style="width: 280px;" type="text" name="limitedpartner.investedtime" onclick="WdatePicker()" readonly="readonly"/><span class="required">*</span></td>
    <td class="t-title">GP出资额（万元）：</td>
    <td><input class="t-text" id="gpcontribution" style="width: 280px;" type="text" name="limitedpartner.gpcontribution" value=""/><span class="required">*</span></td>	
    </tr>
    <tr>
    ...
    <td><select style="width: 300px;" name="calculationmethod">
	 <option value="标准" selected="selected">标准</option>
	 <option value="倒减">倒减</option>
	 </select>	
    </tr>
    </table>
    <div class="t-but">
