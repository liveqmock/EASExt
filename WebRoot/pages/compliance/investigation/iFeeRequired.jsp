		...
		function loadRemoteSelect(id,url){
   		...
   		$(function() {
			 	...
			 	{field:'nextSchemeName',title:'下一步方案',width:fixColumnWidth(0.1400),
			  	...
			  	{field:'operation',title:'操作',width:fixColumnWidth(0.2000),
			  		...
			  		var  result = "<span><a class=\"operation-a\" href='javascript:void(0)' "
			  			+"onclick='openTab1(this,\"协助负责人信息修改\",\"edit\","+node.id+")' >更新邮箱</a>&nbsp;</span>";
		  				return result;
			   		}
		   		});
			...
			$('#tt').datagrid({
				...
				url:'<%=basePath%>/compliance/investigation!queryPageJsonForEamil?type='+type,
...
<div class="search-list">
	...
	<input type="hidden" id="editURL1" value="<%=request.getContextPath()%>/compliance/investigation!findFeedbackRequire?investigationId=" />
