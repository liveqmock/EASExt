...
/**
 * @ZcxzlsfbresultMapper.java	合规（初步调查——再次协助落实反馈结果表Dao）
 * created at 2013-10-8 下午04:57:14 by caoyong
 * 
 * @author caoyong({@link authorEmail})
 * @version $Revision$</br>
 * update: $Date$
 */
public interface ZcxzlsResultMapper extends BaseDAO<ZcxzlsResult, Integer>{
	 ...
	 * @return
	 */
    int insert(ZcxzlsResult zcxzlsfbResult);
     ...
     * @return
     */
    ZcxzlsResult selectByPrimaryKey(Integer id);
     ...
     * @return
     */
    int updateByPrimaryKey(ZcxzlsResult zcxzlsfbResult);
