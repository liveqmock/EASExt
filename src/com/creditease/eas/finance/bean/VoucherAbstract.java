...
/**
 * 凭证摘要
 * @VoucherAbstract.java
 * created at 2013-5-8 下午04:42:21 by ygq
 * 
 * @author ygq({@link authorEmail})
 * @version $Revision$</br>
 * update: $Date$
 */
public class VoucherAbstract implements Serializable{
	private String fnumber;
	private String fname;
	private String 	fvoucherAbstractGroupID;//分组id
	private String 	fdescription;//描述	可选
	public String getFvoucherAbstractGroupID() {
		return fvoucherAbstractGroupID;
	}
	public void setFvoucherAbstractGroupID(String fvoucherAbstractGroupID) {
		this.fvoucherAbstractGroupID = fvoucherAbstractGroupID;
	}
