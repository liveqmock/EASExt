 ...
 * 会计科目类型
 * @AccountType.java
 * created at 2013-5-2 下午09:26:19 by ygq
 * 
...
public class AccountType implements Serializable {
	...
	private String	faccountTableNumber;//科目表编码
	private String	fparentNumber;//上级科目类别
	private String	fproperty;//科目性质(资产=0,负债=1,权益=2,成本=3,损益=4,表外=5,共同=7,其他=6)
