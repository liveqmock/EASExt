...
/**
 * @ConverterToSpell.java
 * created at 2013-3-18 下午02:30:56 by xjw
 * 
...
public class CharacterParser {
	...
	public static void main(String[] args) {
		...
		System.out.println(parser.getSelling("中华人民共和国 吕 绿 律 留 录 陆 鋆 云 毓鋆 行"));
		System.out.println(parser.getSelling("转 正 合 同 司 龄 预 警 按 照 需 求 文 档 抄 送 直 接 上 级 或 隔  时 使 用 表 格 汇 总 的方式 按 月 发送 表格 格式 见 附 表"));
	}
