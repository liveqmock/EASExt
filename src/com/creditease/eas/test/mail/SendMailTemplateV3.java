...
/**
 * 这个版本：将String拼接字符串的方式改成了StringBuffer拼接字符串的方式
 * @SendMailTemplateV3.java
 * created at 2013-2-5 下午07:41:38 by ygq
 * 
 * @author ygq({@link authorEmail})
 * @version $Revision$</br>
 * update: $Date$
 */
public class SendMailTemplateV3 {
	/**
	 * 
	 * 描述：获取中心的部门名称
...
//	}
	...
	public static String setDisplayName(Object fdisplayname){
		...
		if(strs == null || strs.length == 0){
			for(int i=0;i<4;i++){
				sb.append("<td nowrap><font size='2'></font></td>");
			}
			return sb.toString();
		}
		//其他的情况:判断是否大于5级部门了
		...
		for(int i=1;i<end;i++){
			sb.append("<td nowrap><font size='2'>" +strs[i]+ "</font></td>");
		}
		//如果不到6级，就赋空值
		if(strs.length<6){
...
//	}
	...
	public static String htmlContent(List<Map<String,Object>> list){
		...
		html.append("<td nowrap><font color='white' size='2'>员工编号</font></td>");
		html.append("<td nowrap><font color='white' size='2'>身份证姓名</font></td>");
		html.append("<td nowrap height='20'><font color='white' size='2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;一级部门&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>");
		html.append("<td nowrap height='20'><font color='white' size='2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;二级部门&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>");
		html.append("<td nowrap height='20'><font color='white' size='2'>&nbsp;&nbsp;&nbsp;三级部门&nbsp;&nbsp;&nbsp;</font></td>");
		html.append("<td nowrap height='20'><font color='white' size='2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;四级部门&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></td>");
		html.append("<td nowrap height='20'><font color='white' size='2'>&nbsp;&nbsp;&nbsp;五级部门&nbsp;&nbsp;&nbsp;</font></td>");
		html.append("<td nowrap><font color='white' size='2'>城市</font></td>");
		html.append("<td nowrap><font color='white' size='2'>岗位</font></td>");
		html.append("<td nowrap><font color='white' size='2'>任职资格</font></td>");
		html.append("<td nowrap><font color='white' size='2'>人员状态</font></td>");
		html.append("<td nowrap><font color='white' size='2'>入职日期</font></td>");
		html.append("<td nowrap><font color='white' size='2'>预计转正日期</font></td>");
		html.append("<td nowrap bgcolor='orange'><font color='white' size='2'>预警类型</font></td>");
		html.append("</tr>");
		for(int i =0;i<list.size();i++){
			Map<String,Object> mp = list.get(i);
			String personcode = (String)mp.get("PERSONCODE");
...
//			String PROBZZ = DateUtil.formatTimestampToString((TIMESTAMP)mp.get("PROBZZ"));//预计转正日期
			...
			html.append("<td nowrap><font size='2'>"+personcode+"</font></td>");
			html.append("<td><font size='2'>" + personname + "</font></td>");
			//设置displayName
		     html.append(setDisplayName(mp.get("FDISPLAYNAME")));
		     html.append("<td nowrap><font size='2'>" +city+"</font></td>");
    		 html.append("<td nowrap><font size='2'>" +positionname + "</font></td>");
			 html.append("<td nowrap><font size='2'>" +pqfname + "</font></td>");
			 html.append("<td nowrap><font size='2'>" +status+ "</font></td>");
			 html.append("<td nowrap><font size='2'>" +fenterdate+ "</font></td>");
			 html.append("<td nowrap><font size='2'>" +probzz+ "</font></td>");
			 html.append("<td nowrap><font size='2'>"+((entmonth <6)?"试用期将到期":"试用期已到期") +"</font></td>");
		}
		 html.append("</tr></table><br/>");
		 html.append("附：员工转正审批流程：<br/>");
