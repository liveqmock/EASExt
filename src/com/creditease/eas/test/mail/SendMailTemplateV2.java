...
/**
 * 这个版本里：添加上了html标记和样式。
 * @SendMailTemplateV2.java
 * created at 2013-2-5 下午06:32:34 by ygq
 * 
 * @author ygq({@link authorEmail})
 * @version $Revision$</br>
 * update: $Date$
 */
public class SendMailTemplateV2 {
	/**
	 * 
	 * 描述：获取中心的部门名称
...
//	}
	...
	public static String htmlContent(List<Map<String,Object>> list){
		String htmlContent = "<html><head>" +
				...
				"</head>" +
				"<body>" +
				"<div style='line-height: 150%;font-family: 宋体;font-size: 14px;'>各位好！</div>" +
				"<div class='div28'>根据《中华人民共和国劳动合同法》相关规定，用人单位与劳动者签订三年以上固定期限劳动合同，试用期不得超过六个月。</div>"+
				"<div class='div28'>为避免公司用工风险、保护员工用工权益，特提醒部门务必于员工试用期到期日前15个工作日内、完成转正/解除劳动关系相关手续的办理。</div>"+ 
				"<div class='div28'>以下为本团队即将转正人员名单，请查阅并参考邮件所附《员工转正审批流程》办理相关手续：</div>";
...
//			String PROBZZ = DateUtil.formatTimestampToString((TIMESTAMP)mp.get("PROBZZ"));//预计转正日期
			...
			"<td nowrap><font size='2'>"+personcode+"</font></td>" +
			"<td><font size='2'>" + personname + "</font></td>";
			//设置displayName
			html += setDisplayName(mp.get("FDISPLAYNAME"));
			html +=	"<td nowrap><font size='2'>" +city+"</font></td>" +
					"<td nowrap><font size='2'>" +positionname + "</font></td>" +
					"<td nowrap><font size='2'>" +pqfname + "</font></td>" +
					"<td nowrap><font size='2'>" +status+ "</font></td>"+
					"<td nowrap><font size='2'>" +fenterdate+ "</font></td>"+
					"<td nowrap><font size='2'>" +probzz+ "</font></td>"+
					"<td nowrap><font size='2'>"+((entmonth <6)?"试用期将到期":"试用期已到期") +"</font></td>";
		}
		html += "</tr></table><br/>";
		html += "附：员工转正审批流程：<br/>"+ 
		"<div class='div28'>1、主管级（含）以下员工</div>"+ 
		"<div class='div50'>由部门根据员工日常工作表现进行评估、审批，并根据审批结果进行相关手续办理：</div>"+ 
		"<div class='div50'>▉如部门同意员工转正：</div>"+ 
		"<div class='div72'>a.员工直接上级与即将转正员工进行试用期面谈，双方达成一致后由员工本人填写《新员工转正评估表》并提交部门审批；</div>"+ 
		"<div class='div72'>b.部门完成审批手续后将《新员工转正评估表》提交总部人力资源与行政部备案（外埠地区将表单以扫描件形式予以呈报）。</div><br/>"+ 
		"<div class='div50'>▉如部门不同意员工转正</div>"+ 
		"<div class='div72'>a.请部门务必于试用期到期前与员工协商一致、依据公司相关规定办理正常离职手续。</div><br/>"+ 
		"<div class='div28'>2、经理级以上员工</div>"+ 
		"<div class='div50'>由部门根据员工实际工作表现进行评估、审核，并根据审核结果进行相关手续办理：</div>"+ 
		"<div class='div50'>▉如部门同意员工转正：</div>"+ 
		"<div class='div72'>a.员工直接上级与即将转正员工进行试用期面谈，双方达成一致后由员工本人填写《新员工转正评估表》并提交部门审核；</div>"+ 
		"<div class='div72'>b.部门完成审核手续后将《新员工转正评估表》提交总部人力资源与行政部审批（外埠地区将表单以扫描件形式予以呈报）；</div>"+ 
		"<div class='div72'>c.如该转正申请未通过审批，总部人力资源与行政部将予以邮件反馈。</div><br/>"+ 
		"<div class='div50'>▉如部门不同意员工转正</div>"+ 
		"<div class='div72'>a.部门将不同意员工转正的意见及相关材料提交总部人力资源与行政部审批（外埠地区将表单以扫描件形式予以呈报）；</div>"+ 
		"<div class='div72'>b.根据员工实际情况进行相关手续办理。</div><br/>"+ 
		"感谢您对人力资源与行政部工作的大力支持！谢谢。";
		htmlContent += html;
		htmlContent += "</div><br/><img src='cid:xx.jpg'><br/>" +
				"------------------------------------------------------------------<br/>"+
				"传真： 010- 5738 2188<br/>"+
				"网站： www.CreditEase.cn<br/>"+
				"地址： 北京市朝阳区建国路88号SOHO现代城C座16层<br/>"+
				"邮编： 100022<br/>" +
				"</body>";
		return htmlContent;
	}
