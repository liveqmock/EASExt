...
public interface PortInfoService {
	...
	public int insert(PortInfo portInfo) throws Exception;
	
	public Pagination queryPage(Pagination page) throws Exception;
	
	public int delete(Integer id) throws Exception ;
	
	public int update(PortInfo portInfo) throws Exception ;
	
	public PortInfo getPortInfoById(Integer id) throws Exception;
